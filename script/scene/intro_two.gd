...
func _build_ui():
	...
	info_graphic.texture = assets.textures['secondary_'+OD.DungeonSettings.get_settings()['hero']]
	vertical.add_child(info_graphic)
	
	var next_button = OD.Chrome.invisible_button()
